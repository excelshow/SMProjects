...
class CI_Email {
    ...
    var $mailpath = "D:\xampp\sendmail"; // Sendmail path
    var $protocol = "smtp"; // mail/sendmail/smtp
    var $smtp_host = "mail.semir.com";  // SMTP Server.  Example: mail.earthlink.net
    var $smtp_user = "lizhi@vip.semir.com";  // SMTP Username
    var $smtp_pass = "123456789";  // SMTP Password
