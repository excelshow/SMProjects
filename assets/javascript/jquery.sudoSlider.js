/*
 *  Sudo Slider ver 1.0.2 - jQuery plugin 
			...
			{	
				...
				function fadeControl (fadeOpacity,fadetime,nextcontrol)
				{
					...
					if(optionscustomLink)
					{
						...
						.fadeTo(fadetime, fadeOpacity, function() { if (fadeOpacity == 0) $(this).hide();}).children().fadeTo(fadetime, fadeOpacity, function() {  if (fadeOpacity == 0) $(this).hide();});
					} 
				};
