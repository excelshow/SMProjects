(function(a) {
    a.alerts = {
        ...
        _show: function(j, b, k, g, m, l, c, f, n) {
            ...
            a("body").append('<div id="popup_container" style="display:none"><h1 id="popup_title"></h1><em id="ctl"></em><em id="cbl"></em><em id="ctr"></em><em id="cbr"></em><span id="popup_close"></span><div id="popup_content"><form action="" method="post" id="hiAlertform"><div id="popup_message"></div></form></div></div>');
            if (a.alerts.dialogClass) {
