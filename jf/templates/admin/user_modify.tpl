        ...
        fields: {
		 ...
		 var post_data = $("#subForm").serializeArray();
				...
				//alert($("input[name=id]").val());
                    ...
                    post_url = "{%site_url('admin/system/user_edit_do')%}";//"{%site_url('admin/homepage/add')%}";
...
<!-- modal body start -->
        <div class="form-group form-group-sm">
                <label class="col-sm-3 control-label" for="username">Login Name</label>
                 <div class="col-sm-8">
                   <input type="text" class="form-control" name="username"  id="username" placeholder="Login name" value="{%$user->username%}">
             ...
             <div class="form-group form-group-sm">
                <label class="col-sm-3 control-label" for="nickname">Nick Name</label>
                 <div class="col-sm-8"> 
                    <input type="text" class="form-control" name="nickname"  id="nickname" placeholder="nick name" value="{%$user->nickname%}">
                </div>  
         	</div>
          <div class="form-group form-group-sm">
                <label class="col-sm-3 control-label" for="iphone">Phone Number</label>
                 <div class="col-sm-8"> 
                    <input type="text" class="form-control" name="iphone"  id="iphone" placeholder="Phone Number" value="{%$user->phone%}">
                </div>  
         	</div>
        <div class="form-group form-group-sm">
          ...
          <div class="form-group form-group-sm">
                <label class="col-sm-3 control-label" for="email">E-mail</label>
                 <div class="col-sm-8">
                    <input type="text" class="form-control" name="email"  id="email" placeholder="Contact E-mail" value="{%$user->email%}">
                ...
                <label class="col-sm-3 control-label" for="user_group">Group</label>
                 <div class="col-sm-8"> 
                   <select name="user_group" id="user_group" data-toggle="select" class="form-control ">
                  	...
                  	<option value="{%$row->group_id%}"  {%if ($user->group_id==$row->group_id)%} selected="selected" {%/if%}>{%$row->group_name%}</option> 
                  {%/foreach%}
                  </select>
                </div>  
         	</div>
