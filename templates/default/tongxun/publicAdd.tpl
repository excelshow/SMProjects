...
$(document).ready(function(){
 var fromActAdd = {
			...
			submitHandler : function(){
						   ...
						   url = "{%site_url('tongxun/tongxun/publicAddDo')%}";
						   hiClose();
						   $.ajax({
								 type: "POST",
									url: url,
  ...
  <div class="staffadd pad5 " style="  ">
    ...
    <div class="staffformInfo fleft">
          ...
          <div class="formcontrol">
            <input name="sap_name"  class="inputText" type="text" id="sap_name"   value="" />
          </div>
          <div class="formLine  clearb" ></div>
          <div  class="formLab">排序</div>
      <div class="formcontrol">
        <input name="sap_sort"  class="inputText" type="text" id="sap_sort"    value="" />
      </div>
          <div class="formLine clearb " ></div>
           <div  class="formLab">内容</div>
          <div class="formcontrol">
            <textarea name="sap_info" cols="80" rows="10" class="inputText" id="sap_info"></textarea>
          </div>
          <div class="formLine clearb " ></div>
