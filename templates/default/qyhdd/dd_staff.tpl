...
<script type="text/javascript">
 ...
 $(document).ready(function(){
    ...
    //div高度大于屏幕高度把屏幕高度赋给div，并出现滚动条  
	 ...
	 $.ajax({
            type:'POST',
            url:'{%site_url("qyhdd/qyhdd/dd_dept_tree")%}',
            data:'sd_id = {%$sd_id%}',
            dataType:'json',
            success:function(msg){
                //data = eval(msg); 
                outree = {data: '浙江森马服饰股份有限公司', state : 'open', attr:{'sd_id':'0'},children:  msg};
				$("#localJson").jstree({ 
					'json_data' : {
						'data' : [ outree ]
					},
...
<div class="sidebarLeft ">
    ...
    <!--begin dept -->
  <div class="pad10">
    <div class="ouTreeTitle" style="background:#06F">钉钉组织</div>
    <div class="ouTree pad5" style="background:#E8F8FF">
...
<div class="pad10">
  ...
  <div  class="pageTitleTop">钉钉用户管理 &raquo; 基本信息 &raquo; </div>
