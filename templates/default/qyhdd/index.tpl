...
<script type="text/javascript">
 ...
 $(document).ready(function(){
    ...
    //div高度大于屏幕高度把屏幕高度赋给div，并出现滚动条  
	 ...
	 $.ajax({
            type:'POST',
            url:'{%site_url("qyhdd/qyhdd/qyh_dept_tree")%}',
            data:'sd_id = {%$sd_id%}',
            dataType:'json',
        ...
        function postdn(val){
			 $.ajax({
                type: "POST",
                url: '{%site_url("qyhdd/qyhdd/qyh_deptselect")%}',
                cache:false,
                data: 'id='+val,
                success: function(msg){
                    $("#ouShow").html(msg);
...
<div class="sidebarLeft ">
    ...
    <!--begin dept -->
  <div class="pad10">
    <div class="ouTreeTitle"  style="background:#060;">企业号</div>
    <div class="ouTree pad5" style="background:#EEFFF7">
...
<div class="pad10">
  ...
  <div  class="pageTitleTop">企业号用户&raquo; 基本信息 &raquo; </div>
