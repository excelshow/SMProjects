...
$config['DX_roles_table'] = 'user_roles';
$config['DX_permissions_table'] = 'user_permissions';
$config['DX_login_attempts_table'] = 'user_login_attempts';
...
$config['DX_recaptcha_public_key'] = '213'; 
$config['DX_recaptcha_private_key'] = '123';
...
$config['DX_deny_uri'] = '/system/auth/deny/';
$config['DX_login_uri'] = '/system/auth/login/';
...
// URI Locations
$config['DX_logout_uri'] = '/system/auth/logout/';
