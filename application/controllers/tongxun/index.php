...
class Index extends CI_Controller {
    ...
    function showConMenu() {
        $showmenu = NULL;
        $showmenu .= "<li><a href=" . site_url("tongxun/index") . " >员工联系信息</a></li>";
        $showmenu .= "<li><a href=" . site_url("tongxun/index/publiclist") . " >公共联系信息</a></li>";
    ...
    function stafflist() {
        ...
        // print_r($data['staffs']);
        $linkUrl = "tongxun/index/stafflist/" . $id . "/";
