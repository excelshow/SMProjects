...
class adLDAP {
     ...
     * @var string
     */
    protected $accountSuffix = "@semir.cn";
    /**
     ...
     * @var string
     */
    //protected $baseDn = "cn=administrator,cn=users,dc=lzd,dc=com";
    protected $baseDn = "dc=semir,dc=cn";
    /**
     ...
     * @var array
     */
    protected $domainControllers = array("10.90.18.1"); //"NEWYORK.lzd.com  10.80.18.153
    /**
     ...
     * @var string
     */
    protected $adminUsername = "AppSystem";
    protected $adminPassword = "Semir@app";
   // protected $adminUsername = "administrator";
   // protected $adminPassword = "ADadmin_lh_2689";
    /**
    ...
    public function adldap_schema($attributes) {
        ...
        // array_walk($attributes, array($this, 'encode8bit')); lizd11
